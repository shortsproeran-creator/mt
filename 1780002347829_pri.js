// ==========================================
// ১. ভিডিও পপআপ এবং লোডার HTML বডিতে ইনজেক্ট করা (সবার আগে)
// ==========================================
var popupHTML = `
<div id="videoPopup">
  <div id="container">
...
// ==========================================
// ২. Plyr-এর অফিশিয়াল CSS এবং আপনার কাস্টম CSS ইনজেক্ট করা
// ==========================================
...
// ==========================================
// ৩. HTML লোড নিশ্চিত করে Plyr ইনিশিয়ালাইজ করা
// ==========================================
...
// ==========================================
// ৪. টাইমলাইন এবং ওরিয়েন্টেশন রোটেশন মেকানিজম
// ==========================================
...
// মেইন ওপেন ফাংশন (আপনার পুরনো কোডের আইডি ট্রিগার মেথড)
function openPlayer() {
  ...
  // ক্লিক করা পোস্টার এলিমেন্ট থেকে data-id রিড করা
  var clickedElement = event.currentTarget;
  var videoId = clickedElement.getAttribute('data-id');
  
  // গিটহাবের ভেতর ওয়ার্কার্স লিংক লক করা হলো
  ...
  // আপনার পুরনো সেই সাকসেসফুল প্লে লজিক
